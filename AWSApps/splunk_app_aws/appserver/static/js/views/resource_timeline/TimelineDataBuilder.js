    ...
    function TimelineDataBuilder(model){
        ...
        var configSM = new SearchManager({
            ...
            search: '`aws-config-notification($accountId$, $region$)` $resourceIdConfigFilter$' +
                    ...
                    '| rename configurationItem.resourceId as resourceId, configurationItem.awsAccountId as accountId, configurationItem.awsRegion as region, configurationItemDiff.changeType as changeType' +
