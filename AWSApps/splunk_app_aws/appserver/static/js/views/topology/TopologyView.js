define([
    ...
    class TopologyView extends SimpleSplunkView {
        ...
        initialize() {
            ...
            this.template = '\
                <div class="aws-topology-list"></div>\
                <div class="aws-topology-chart"></div>\
                <div class="aws-topology-details"></div>\
                <div class="aws-topology-recomm"></div>';
        ...
        createView() {
            ...
            let $list = $('.aws-topology-list');
            let $chart = $('.aws-topology-chart').css('width', (this.$el.width() - $list.outerWidth()) + 'px');
            let $details = $('.aws-topology-details');
            let $recomm = $('.aws-topology-recomm');
            ...
            $('body').on('mousewheel', function(event){
                if ($('#fit-size').val() === 'screen' && $(event.target).parents('.aws-topology-details').length===0) {
                    return false;
                }
            });
