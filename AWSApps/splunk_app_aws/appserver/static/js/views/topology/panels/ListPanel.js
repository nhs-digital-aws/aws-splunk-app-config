define([
    ...
    const RESOURCE_GROUPS = ['vpc', 'i', 'subnet', 'vol', 'elb', 'sg', 'eni', 'acl', 'rtb'];
        ...
        formatData(data) {
            ...
            data.forEach((datum) => {
                ...
                relationships.forEach((relationship) => {
                    ...
                    else if (datum.resourceId.indexOf('i-') === 0){
                        usedEC2Ids[datum.resourceId] = true;
                    }
                });
            });
